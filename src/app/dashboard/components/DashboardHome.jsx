...
import Store from './DashBoardHomeStore';
...
let ConfigData = {
    ...
    header: 'Top Search Queries Chart',
    bread_crumb: [
        {name: 'Search'},
...
let dashboardHome = React.createClass({
    ...
    getInitialState() {
        ...
        this.registerStores({
            [DashboardStoreKey]: {dataKey: 'dashboardHomeData'}
        });

        return {
            dashboardHomeData: this.store.data
        };
    },
        ...
        return (<div className="chart-summary">
            <table>
                ...
                <tr>
                    ...
                    <td >Average Response Time - {dataTmp.Average_Response_Time} ms</td>
                </tr>
                </tbody>
            </table>
        </div>);
    ...
    buttonClicked(index, value){
        ...
        return (e) => {
            ...
            const dashBoardHomeData = this.state.dashboardHomeData;
            ...
            if (index === 1) {
                ...
                if (selectedDataTmp.category === value) {
                    ...
                    if (value === 'autocomplete') {
                        baseData.header = 'Top Auto-complete Queries Chart';
                    } else {
                        baseData.header = 'Top Search Queries Chart';
                    }
